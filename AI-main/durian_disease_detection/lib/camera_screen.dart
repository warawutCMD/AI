...
class _CameraScreenState extends State<CameraScreen> {
  ...
  // String apiUrl =
  //     "https://run.mocky.io/v3/806edd6c-eec4-49b9-8402-85bd5c5bc4bc";
   String apiUrl = 'http://127.0.0.1:8000/predict'; // Localhost URL
        ...
        if (mounted) {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder:
                  (context) =>
                      ResultScreen(result: result, imageFile: imageFile),
            ),
          );
        }
      } else {
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  onPressed:
                      _isLoading ? null : () => _getImage(ImageSource.gallery),
                ),
              ],
            ),
            // SizedBox(height: 10),
